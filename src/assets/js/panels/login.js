...
class Login {
    ...
    loginMojang() {
        ...
        loginBtn.addEventListener("click", () => {
            ...
            infoLogin.innerHTML = "Соединение...";
    ...
    loginOffline() {
        ...
        mojangBtn.innerHTML = "Авторизация";
        document.querySelector(".login-card-mojang-input").querySelector("label").innerHTML = "Nickname";
        document.querySelectorAll(".login-card-mojang-input")[1].style.display = "none";
